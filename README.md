...
1) Скачать IVernarus1.
   ...
   - Если вы новый пользователь, то качайте `dist/ivernarus1.html`.
   - Если вы уже используете версию скачанную до 2026.03.11, или ваш собеседник ее использует, то качайте `dist/ivernarus1_v1.html` .
...
4) Ваш контакт должен также скачать `dist/ivernarus1.html` к себе на устройство и создать контакт для общения с вами. Но вместо генерации ключа он должен нажать "Нажмите для импорта ключа" и загрузить туда переданный вами ключ. Потом нажать сохранить. Можно переходить к общению.
