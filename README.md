...
1) Скачать IVernarus1. Если вы новый пользователь, то качайте `dist/ivernarus1.html` и переходите к п.2 . Но если вы уже использовали версию скачанную до 2026.03.11, или ваш собеседник ее использует, то качайте `dist/ivernarus1_v1.html` . Сохраните html-файл на телефон или компьютер и откройте в браузере(лучше firefox/chrome/vivaldy/opera - стандартный веб броузер андроида криво экспортирует ключи). Вы должны всегда открывать файл из одного и того же места одним и тем же браузером, иначе база ключей и контактов потеряется. Поэтому перед перемещением файла или сменой браузера явно экспортируйте и импортируйте базу.
